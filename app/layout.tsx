  ...
  return (
    <html lang="es">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Aboreto&family=Asset&family=JetBrains+Mono:wght@600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700&family=Space+Grotesk:wght@700;800&family=Unbounded:wght@700;800;900&display=swap"
          rel="stylesheet"
        />
        <script
